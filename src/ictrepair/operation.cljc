(ns ictrepair.operation
  ...
  routed through the Repair Governor (:govern) and the rollout phase
  ...
  :rejected). `:repair/complete`/`:device/return` ALWAYS reach this
  node when the governor is clean -- see `ictrepair.phase`."
  (:require [langgraph.graph :as g]
            [langgraph.checkpoint :as cp]
            [ictrepair.repairopsllm :as repairopsllm]
...
(defn build
  ...
  `ictrepair.store/Store`).
  opts:
    :advisor      -- a `ictrepair.repairopsllm/Advisor` (default: mock-advisor)
