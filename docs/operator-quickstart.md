# Operator Quickstart — Community ICT Equipment Repair

Shortest path from clone to a verified local dry-run for **ISIC 9511** (`cloud-itonami-isic-9511`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9511.git
cd cloud-itonami-isic-9511
```
...
- Blueprint governor key: `repair-governor`
- Likely source path: `ictrepair.governor.cljc`
